...
from luml_prisma.services.orchestrator.nodes.result_file import (
    ARTIFACT_FILENAME,
    RESULT_DIR,
)
...
logger = logging.getLogger("luml_prisma.orchestrator")
...
class OrchestratorEngine:
    ...
    def _build_context(
        ...
        from luml_prisma.config import load_config as load_app_config
