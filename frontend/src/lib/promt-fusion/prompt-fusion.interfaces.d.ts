import type { FieldVariant, NodeTypeEnum, PromptFieldTypeEnum } from '@/components/express-tasks/prompt-fusion/interfaces';
...
export declare enum ProviderModelsEnum {
    gpt4o = "gpt-4o",
...
export declare enum EvaluationModesEnum {
