...
class DatabaseServiceClass {
    ...
    async createDatabase(id, metadata) {
    ...
    async getDatabasesWithMetadata() {
        const databases = await this.getDatabases();
        const filteredDatabases = databases.filter((database) => database.name && database.name.startsWith(DATABASE_PREFIX));
    ...
    async editDatabase(name, metadata) {
