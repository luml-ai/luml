import { Zap, File, MessageCircleCode, Folders, Pyramid, Rocket, Satellite, ChartSpline, } from 'lucide-vue-next';
...
const appTasks = [
    {
        ...
        tooltipData: 'This task focuses on analyzing table-structured data to classify rows into predefined categories. Each row represents an observation, and the model uses the provided features (columns) to predict the target category.',
        isAvailable: true,
    ...
    },
    {
        ...
        btnText: 'next',
        linkName: 'regression',
        tooltipData: 'This task involves analyzing table-structured data to predict continuous numerical values. Each row represents an observation, and the model uses the features (columns) to estimate the target variable.',
        isAvailable: true,
    ...
    },
    {
        ...
        description: 'Construct and optimize LLM flows using a no-code builder — suitable for various NLP tasks, including text classification and structured information extraction.',
        btnText: 'next',
        tooltipData: 'Define and automatically optimize generic LLM-based NLP pipelines using a no-code builder. Optimization can be performed either based on the task structure and description or on the provided labeled input-output pairs. ',
        isAvailable: true,
    ...
    },
    {
        ...
        icon: Notebooks,
        title: 'Notebooks',
        description: 'Run Jupyter notebooks directly in the browser with no setup or backend. Create, test, and export models locally with automatic discovery, while managing instances entirely client-side.',
        btnText: 'next',
        linkName: 'notebooks',
        tooltipData: 'Run Jupyter notebooks fully in the browser using a WebAssembly-based Python runtime with no backend or setup required. All data is stored locally in the browser, with options to export, back up, and automatically surface saved models in the platform UI.',
        isAvailable: true,
    ...
    },
    {
        ...
        btnText: 'coming soon',
        tooltipData: 'This task focuses on analyzing historical time-series data to predict future trends or values over a specified period. It involves identifying patterns, seasonality, and trends in the data.',
        isAvailable: true,
        isDisabled: true,
        analyticsTaskName: '',
    },
