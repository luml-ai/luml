...
export const getEmptyProcessorNode = () => ({
    id: uuidv4(),
    type: 'custom',
    data: {
        label: 'Processor',
...
export const getInputNode = (fields) => {
    return {
        id: uuidv4(),
        type: 'custom',
        data: {
...
export const getOutputNode = (fields) => {
    return {
        id: uuidv4(),
        type: 'custom',
        data: {
...
export const getInitialNodes = (inputFields, outputFields) => {
...
export const getSample = (inputs, outputs) => {
    const edges = [];
    const nodes = [];
