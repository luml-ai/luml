...
const createMockOrbit = (id, overrides = {}) => ({
    ...baseOrbit,
    id,
    name: `Orbit ${id}`,
    ...overrides,
});
const createMockMember = (id, orbit_id, userId, role) => ({
    id,
    orbit_id,
    role,
    user: {
...
const createMockOrbitDetails = (id, overrides = {}) => ({
    ...createMockOrbit(id),
    members: overrides.members ?? [
        createMockMember('22222222-2222-2222-2222-222222222222', id, '33333333-3333-3333-3333-333333333333', OrbitRoleEnum.member),
    ],
    ...overrides,
});
describe('OrbitsStore', () => {
    ...
    describe('5 - deleteOrbit', () => {
        it('removes orbit from list', async () => {
            ...
            expect(mockApi.deleteOrbit).toHaveBeenCalledWith(ORG_ID, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0002');
        ...
        it('resets current orbit when deleting the active one', async () => {
            ...
            mockApi.getOrbitDetails.mockResolvedValueOnce(createMockOrbitDetails('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0002'));
        ...
        it('does not reset current orbit when deleting a different one', async () => {
            ...
            mockApi.getOrbitDetails.mockResolvedValueOnce(createMockOrbitDetails('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0001'));
        ...
        it('does not remove the orbit from the list if the API call fails', async () => {
            ...
            await expect(store.deleteOrbit(ORG_ID, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0002')).rejects.toThrow('Deletion failed');
            expect(store.orbitsList).toEqual(initialOrbits);
    ...
    describe('6 - members', () => {
        it('addMemberToOrbit calls API and returns OrbitMember', async () => {
            ...
            const addedMember = createMockMember('44444444-4444-4444-4444-444444444444', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0001', '33333333-3333-3333-3333-333333333333', OrbitRoleEnum.member);
        ...
        it('getOrbitDetails returns details', async () => {
            ...
            expect(mockApi.getOrbitDetails).toHaveBeenCalledWith(ORG_ID, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0001');
            expect(result).toEqual(details);
        });
        it('deleteMember calls API', async () => {
            mockApi.deleteOrbitMember.mockResolvedValueOnce({ detail: 'success' });
            await store.deleteMember(ORG_ID, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0001', '33333333-3333-3333-3333-333333333333');
            expect(mockApi.deleteOrbitMember).toHaveBeenCalledWith(ORG_ID, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0001', '33333333-3333-3333-3333-333333333333');
        });
        it('updateMember calls API and returns OrbitMember', async () => {
            ...
            const updatedMember = createMockMember('33333333-3333-3333-3333-333333333333', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0001', '33333333-3333-3333-3333-333333333333', OrbitRoleEnum.admin);
            ...
            expect(mockApi.updateOrbitMember).toHaveBeenCalledWith(ORG_ID, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaa0001', data);
    ...
    describe('7 - setCurrentOrbitId', () => {
        ...
        it('ignores stale response when orbit changed during load', async () => {
            ...
            mockApi.getOrbitDetails
                .mockImplementationOnce(() => new Promise((resolve) => setTimeout(() => resolve(details1), 100)))
