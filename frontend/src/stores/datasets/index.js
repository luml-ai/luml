...
export const useDatasetsStore = defineStore('datasets', () => {
    ...
    const manifest = computed(() => {
        ...
        if (!artifactsStore.currentArtifact || !isDataset)
            return null;
        return artifactsStore.currentArtifact.manifest;
    });
    ...
    function setSelectedSubset(subsetName) {
        if (!subsetName) {
    ...
    function setSelectedSplit(splitName) {
        if (!splitName) {
    ...
    async function setDownloader(artifact) {
    ...
    async function getChunkData(page) {
    ...
    function getDataFromBuffer(arrayBuffer) {
    ...
    async function getParquetData(arrayBuffer) {
