...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Form used inside the New Item dialog when creating a workflow (orchestrated run). Collects the objective, agent, auto-mode, optional LUML collection upload, and an Advanced section with depth/fork/concurrency/timeout knobs.',
            },
        },
    },
    decorators: [
