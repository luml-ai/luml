...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A single column of the Prisma board. Renders a header (title + count badge, optional fail count), an optional "New" button, and a draggable list of BoardCards.',
            },
        },
    },
    decorators: [
