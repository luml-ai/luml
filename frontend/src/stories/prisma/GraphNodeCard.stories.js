...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Node card rendered inside the Prisma run graph (VueFlow). Shows node type, status dot/label, a score for `run` nodes, a `best` badge, and a terminal icon when a session is attached.',
            },
        },
    },
    decorators: [
...
export const ImplementSucceeded = {
...
export const Running = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Running node shows a terminal icon in the header. Clicking it fires `onOpenTerminal(sessionId)`.',
            },
        },
    },
};
export const WaitingInput = {
    args: {
        data: {
            ...waiting,
            onOpenTerminal: (id) => console.log('open terminal', id),
