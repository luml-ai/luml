...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Card shown in each column of the Prisma board. Displays a task or run with its name, repository, status tag, relative updated time and contextual action buttons (Start shown only when status is `pending`).',
            },
        },
    },
    decorators: [
