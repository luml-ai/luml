  ...
  >
    <div class="dialog-content">
      ...
      <div class="body">
        ...
        <Form id="createInviteForm" :initialValues :resolver v-slot="{ email }" :validateOnValueUpdate="false" @submit="onFormSubmit" class="form">
          <div class="form-field">
            <InputText name="email" placeholder="Email" class="form-input":invalid="email?.invalid"/>
