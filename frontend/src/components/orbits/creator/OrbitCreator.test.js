        ...
        wrapper = mount(OrbitCreator, {
            global: {
                ...
                stubs: {
                    ...
                    InputText: {
                        template: '<input :id="id" :name="name" :placeholder="placeholder" v-model="modelValue" @input="$emit(\'update:modelValue\', $event.target.value)" />',
                    ...
                    Checkbox: {
                        template: '<input type="checkbox" :id="inputId" v-model="modelValue" @change="$emit(\'update:modelValue\', $event.target.checked)" />',
                    ...
                    'd-button': {
                        template: '<button :class="className" :variant="variant" :size="size" :as-child="asChild"><slot></slot></button>',
