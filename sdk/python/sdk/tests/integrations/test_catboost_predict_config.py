...
def test_ntree_end(ctb_regressor_ndarray_native, regressor, X_test) -> None:
...
def test_ntree_start_end(ctb_regressor_ndarray_native, regressor, X_test) -> None:
...
def test_prediction_type_probability(
    ctb_classifier_ndarray_native, classifier, X_test
) -> None:
