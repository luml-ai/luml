...
async def demo_organizations() -> None:
    ...
    organization_by_id = await dfs.organizations.get(
        "0199c455-21ec-7c74-8efe-41470e29bae5"
    )
...
async def demo_bucket_secrets() -> None:
    ...
    secret = await dfs.bucket_secrets.get("0199c455-21ed-7aba-9fe5-5231611220de")
    ...
    await dfs.bucket_secrets.delete("0199c455-21ed-7aba-9fe5-5231611220de")
...
async def demo_orbits() -> None:
    ...
    # Get Orbit by id
    orbit_by_id = await dfs.orbits.get("0199c455-21ed-7aba-9fe5-5231611220de")
    ...
    # Delete Orbit
    await dfs.orbits.delete("0199c455-21ed-7aba-9fe5-5231611220de")
...
async def demo_collections() -> None:
    ...
    collection_by_id = await dfs.collections.get("0199c455-21ee-74c6-b747-19a82f1a1e75")
    ...
    # Delete collection
    await dfs.collections.delete("0199c455-21ee-74c6-b747-19a82f1a1e75")
...
async def demo_model_artifacts() -> None:
    ...
    # Get model by ID
    model_by_id = await dfs.model_artifacts.get("0199c455-21ee-74c6-b747-19a82f1a1e75")
    ...
    # Get download URL
    download_url = await dfs.model_artifacts.download_url(
        "0199c455-21ee-74c6-b747-19a82f1a1e75"
    )
    print(f"Model Download URL: {download_url}")

    # Get delete URL
    delete_url = await dfs.model_artifacts.delete_url(
        "0199c455-21ee-74c6-b747-19a82f1a1e75"
    )
    ...
    await dfs.model_artifacts.delete("0199c455-21ee-74c6-b747-19a82f1a1e75")
