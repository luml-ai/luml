...
from luml_api._types import Organization
...
def test_organization_list(
    ...
    mock_sync_client.get.assert_called_once_with("/api/v1/users/me/organizations")
    assert len(orgs) == 1
...
async def test_async_organization_list(
    ...
    mock_async_client.get.assert_called_once_with("/api/v1/users/me/organizations")
    assert len(orgs) == 1
