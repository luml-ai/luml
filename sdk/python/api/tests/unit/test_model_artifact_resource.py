...
def test_artifact_list(mock_sync_client: Mock, sample_artifact: Artifact) -> None:
    ...
    mock_sync_client.get.assert_called_once_with(
        f"/api/v1/organizations/{organization_id}/orbits/{orbit_id}/collections/{collection_id}/artifacts",
...
def test_artifact_download_url(mock_sync_client: Mock) -> None:
    ...
    mock_sync_client.get.assert_called_once_with(
        f"/api/v1/organizations/{organization_id}/orbits/{orbit_id}/collections/{collection_id}/artifacts/{artifact_id}/download-url"
    )
...
def test_artifact_delete_url(mock_sync_client: Mock) -> None:
    ...
    mock_sync_client.get.assert_called_once_with(
        f"/api/v1/organizations/{organization_id}/orbits/{orbit_id}/collections/{collection_id}/artifacts/{artifact_id}/delete-url"
    )
    assert result == expected
...
def test_artifact_update(mock_sync_client: Mock, sample_artifact: Artifact) -> None:
    ...
    mock_sync_client.patch.assert_called_once_with(
        f"/api/v1/organizations/{organization_id}/orbits/{orbit_id}/collections/{collection_id}/artifacts/{artifact_id}",
        json=update_data,
    )
    assert artifact.name == name
...
def test_upload_forwards_on_progress(
    ...
    with (
        ...
        patch("luml_api.resources.artifacts.UploadService") as mock_upload_service_cls,
    ):
