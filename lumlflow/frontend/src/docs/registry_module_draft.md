...
To upload a model or experiment, select it in lumlflow and click **Upload**. The dialog asks you to pick the target Organization, Orbit, and Collection in Luml. If you do not have these set up yet, follow the [From Sign-Up to Deployment](user_guideline_draft.md) guide to create them.
...
*Note: for a detailed look at what the Registry stores and how each tab works, see the [Registry documentation](../documentation/Modules/Registry/registry.md).*