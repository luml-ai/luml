...
async def create_entry(
    ...
    return await entries_handler.create_entry(
...
async def update_entry(
    ...
    return await entries_handler.update_entry(
        request.user.id,
        organization_id,
        orbit_id,
        track_id,
...
@tracks_router.get(
    "/{track_id}/stages",
    responses=endpoint_responses,
    response_model=list[TrackStage],
)
