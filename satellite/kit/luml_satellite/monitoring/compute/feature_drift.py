...
def _numerical_distribution(summary: dict[str, Any], values: list[float]) -> dict[str, Any]:
...
def _categorical_distribution(summary: dict[str, Any], values: list[str]) -> dict[str, Any]:
