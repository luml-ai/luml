...
from luml_satellite.monitoring.compute.models import Severity
...
def has_numerical_reference(summary: dict[str, Any]) -> bool:
...
def has_categorical_reference(summary: dict[str, Any]) -> bool:
